...
long_line = "Tu resteras à jamais dans nos cœurs."
S = 60
while True:
...
lines = [
    ("Papa chéri,", BASE),
    ("Tu resteras à jamais dans nos cœurs.", BASE),
    ("Repose en paix.", BASE),
    ("We love you!", EMPH),
]
y_msg = y + gap_msg
...
draw_tracked(d, W / 2, y_dates, "20 novembre 1948  –  24 mai 2026",
...
out = "memorial_redesign.png" if MODE == "gold" else "memorial_redesign_black.png"
