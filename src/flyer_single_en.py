...
# ---- tagline (italic) ----
d.text((CX, y), "In Loving Memory of Our Dearly Beloved",
...
d.text((CX, y), "You will forever remain in our hearts.",
       font=sc(50), fill=INK_SOFT, anchor="ma")
y += 72
d.text((CX, y), "Rest in Peace.", font=sc(64), fill=GOLD_DARK, anchor="ma")
y += 110
...
d.text((CX, y), "Programme of Visitations",
...
d.text((CX, y), "Every Thursday, Friday and Saturday",
       font=f(32), fill=INK_SOFT, anchor="ma")
y += 46
d.text((CX, y), "from 28 May to 20 June 2026",
       font=f(32), fill=INK_SOFT, anchor="ma")
y += 58
d.text((CX, y), "From Monday 22 to Wednesday 24 June 2026",
       font=f(32), fill=INK_SOFT, anchor="ma")
y += 64

tracked(d, CX, y, "VENUE", f(24), SUBTLE, track=12)
y += 40
d.text((CX, y), "The TOGBEY Family Residence",
       font=fb(36), fill=INK, anchor="ma")
y += 48
d.text((CX, y), "Tokoin Kodomé District · 3rd lane on the right · opposite the market",
...
img.save("flyer_single_en.png", dpi=(300, 300))
